...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        ...
        {
            return isDisposed_ ? throw new ObjectDisposedException("ZipFile") : new ZipEntryEnumerator(entries_);
        }
...
#pragma warning restore IDE0044 // Add readonly modifier
        ...
        private ushort ReadLEUshort()
        {
            ...
            return data2 < 0 ? throw new EndOfStreamException("End of stream") : unchecked((ushort)((ushort)data1 | (ushort)(data2 << 8)));
        }
...
#pragma warning restore IDE0059 // Unnecessary assignment of a value
                ...
                entry.CryptoCheckValue = !entry.HasFlag(GeneralBitFlags.Descriptor) ? (byte)(crc >> 24) : (byte)(dostime >> 8 & 0xff);
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
        ...
        public struct ZipEntryEnumerator(ZipEntry[] entries) : IEnumerator<ZipEntry>
        {
            ...
            /// <inheritdoc />
            public readonly ZipEntry Current => array[index];
...
#pragma warning disable IDE0044 // Add readonly modifier
            private ZipEntry[] array = entries;
#pragma warning restore IDE0044 // Add readonly modifier
            private int index = -1;
        ...
        /// </summary>
        private class UncompressedStream(Stream baseStream) : Stream
        {
...
#pragma warning restore IDE0044 // Add readonly modifier
    ...
    public class StaticDiskDataSource(string fileName) : IStaticDataSource
    {
...
#pragma warning restore CS8603 // Possible null reference return.
    ...
    abstract public class BaseArchiveStorage(FileUpdateMode updateMode) : IArchiveStorage
    {
        ...
        private readonly FileUpdateMode updateMode_ = updateMode;
